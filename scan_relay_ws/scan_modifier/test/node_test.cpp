...
TEST(scan_modifier, lidar_ranges)
{
  ...
  // // Create range with the data 0..359 (inclusive), mimicking that the lidar measures something from 0..359 meters
  // away auto ranges = std::ranges::iota_view{ 0, 360 }; for (std::vector<float>::size_type i = 0; i < 361; i++)
  // {
